...
/**
 * Сторона сохраняемой картинки желания.
 *
 * Больше аватарки, потому что и показывается она крупнее: на экране желания это
 * почти вся ширина, то есть около 1000 физических пикселей на плотном экране.
 * И меньше, чем снимок с камеры: у желания картинок может быть три, а платит за
 * них трафиком каждый, кто открыл чужую доску.
 */
const val WISH_IMAGE_OUTPUT_SIZE_PX: Int = 1080
